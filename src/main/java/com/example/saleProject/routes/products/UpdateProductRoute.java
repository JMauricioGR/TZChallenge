...
import com.example.saleProject.usecases.products.UpdateProductUseCase;
...
public class UpdateProductRoute {
    ...
    @Bean
    @RouterOperation(operation = @Operation(description = "Update product by Id", operationId = "updateProduct",
    ...
    public RouterFunction<ServerResponse> updateRiderRouter(UpdateProductUseCase useCase){
        return route(
